      ...
      <CardContent className="p-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-az-red/10 dark:bg-az-red/20 rounded-full flex-shrink-0">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-2">
            ...
            <Button 
              ...
              className="bg-az-red hover:bg-az-red/90 text-white w-full sm:w-auto px-6 py-2.5 text-sm font-semibold"
              size="default"
            >
              <span className="hidden sm:inline">Instellingen bekijken</span>
              <span className="sm:hidden">Notificatie-instellingen</span>
            </Button>
          </div>
        </div>
      </CardContent>
